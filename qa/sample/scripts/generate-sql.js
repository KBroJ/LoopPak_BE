...
sqlContent += 'INSERT INTO product (name, price, stock, max_order_quantity, brand_id, status, created_at, updated_at, like_count, version)\n';
sqlContent += 'SELECT \n';
...
sqlContent += '  0 as like_count,\n';
sqlContent += '  0 as version\n';
